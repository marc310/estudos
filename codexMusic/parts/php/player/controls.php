<div id="controls">
  ...
  <div class="center">
    <a class="btn-floating btn-flat waves-effect waves-light cyan accent-2 white-text" id="previous"
        title="Play previous ([)"
        onclick="previous()"
        >
    ...
    <a class="btn-floating btn-flat waves-effect waves-light grey accent-2 white-text"
    ...
    <a class="btn-floating btn-flat waves-effect waves-light grey accent-2 white-text" id="stop" title="Stop playback (0)" onclick="stop()">
      <i class="mdi-av-stop"></i></a>

      <a class="btn-floating btn-flat waves-effect waves-light cyan accent-2 white-text" id="next"
          title="Play next (])"
          onclick="nextBtn()"
          >
